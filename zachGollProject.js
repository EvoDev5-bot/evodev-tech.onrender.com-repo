...
let newElem = document.querySelector("#main");
let sideElem;
...
function showMeme() {
  ...
  newElem.setAttribute('width', '300')
  newElem.setAttribute('id', "main")
  // let attribute  = document.createAttribute('src');
  // let heightAttribute = document.createAttribute('height');
  // let widthAttribute = document.createAttribute('width');

  sect.appendChild(newElem);
...
function showRiddle() {
  ...
  newElem.textContent = randomRiddle.question;
  sect.appendChild(newElem);
  newElem.setAttribute('id', "main")


  sideElem = document.createElement('p');

  sideElem.textContent = randomRiddle.answer;
  sideElem.hidden = true;
  sect.appendChild(sideElem);
  sideElem.setAttribute('id', "main")
  isRiddle = true;
}
...
function revealAnswers(
  ...
  if (isRiddle) {
    sideElem.hidden = false;
    answerIsShown = true;
  } else {
    alert("There is no riddle shown on screen.")
  }
