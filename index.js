...
const hashEmpty = document.querySelector("#empty")
...
const hashLogo = document.querySelector("#logo");
...
function goToLink(str) {
    ...
    href = "https://evodev-tech.onrender.com/" + str + ".html"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener('resize', function () {
        ...
        if (window.matchMedia("(min-width: 1120px)").matches) {
            ...
            let neededWidth = eval(530 - hashLogo.getBoundingClientRect().width) + 'px';

            hashEmpty.style.width = neededWidth;
            console.log(eval(530 - hashLogo.getBoundingClientRect().width) + 'px')
